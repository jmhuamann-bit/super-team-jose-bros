...
const FLOR = [   // la flor "paradita" del Campo de Marte: demanda vertical (12 × 12)
  "............",
  "....ppp.....",
  "...ppppp....",
  "..ppyyyypp..",
...
const BANCA = [   // banca del parque: bien echada, como una recta de pendiente 0 (14 × 12)
  "..............",
  "..............",
  ".mmmmmmmmmmmm.",
  ".m..........m.",
...
const ARDILLA = [   // ardilla de cola curva: la que no es lineal (13 × 12)
  ".........ttt.",
  "........tt.tt",
  "..bb....tt.tt",
  ".bbbb...tt.tt",
...
const MONUMENTO = [  // jefe de Jesús María: el monumento que no se mueve ni un milímetro (20 × 16)
  "........cccc........",
  ".......cccccc.......",
  ".......ckkckc.......",
  ".......cccccc.......",
...
const GLOBO = [   // globo de la feria: sube y baja como la pendiente invertida (12 × 12)
  "....rrrr....",
  "...rrrrrr...",
  "..rrrrrrrr..",
  "..rrrrwwrr..",
...
const DIANA = [   // tiro al blanco: tiene puntería pero le falta el punto (12 × 12)
  "............",
  "...rrrrrr...",
  "..rwwwwwwr..",
  ".rwwrrrrwwr.",
...
const ALGODON = [   // algodón de azúcar: todo esponjoso y al revés (12 × 12)
  "............",
  "...ppppp....",
  "..ppppppp...",
  ".ppppppppp..",
...
const PAYASO = [  // jefe de Lince: el payaso de las máximas disposiciones (20 × 16)
  "...rr..........rr...",
  "..rrrr........rrrr..",
  "..rrrrr......rrrrr..",
  "....ccccccccccc.....",
...
const MALETIN = [   // maletín de oficina: se desliza en vez de desplazarse (12 × 12)
  "............",
  "....kkkk....",
  "....k..k....",
  "..bbbbbbbb..",
...
const CORBATA = [   // corbata de San Isidro: nunca sabe con quién se sustituye (12 × 12)
  "............",
  "...ww..ww...",
  "...wwwwww...",
  "....rrrr....",
...
const CAFE = [   // café del Olivar: barato cuando el sueldo baja (12 × 12)
  "............",
  "...vvv......",
  "..v.v.v.....",
  "............",
...
const EJECUTIVO = [  // jefe de San Isidro: el ejecutivo de las expectativas (20 × 16)
  ".......kkkkkk.......",
  "......kkkkkkkk......",
  "......ccccccccc.....",
  ".....ccccccccccc....",
...
const PARAPENTE = [   // parapente del malecón: cree que se aterriza al instante (14 × 12)
  "..............",
  "...mmmmmmmm...",
  "..mmmmmmmmmm..",
  ".mmmmmmmmmmmm.",
...
const TABLA = [   // tabla de surf: confunde escasez con sobreproducción (12 × 12)
  "............",
  ".....ww.....",
  "....wwww....",
  "...wwwwww...",
...
const CANGREJO = [   // cangrejo del acantilado: muy legalista con las leyes (13 × 12)
  ".............",
  ".k.........k.",
  "..k.......k..",
  "...rrrrrrr...",
...
const BOTE = [   // bote del muelle: multiplica el precio en vez de la cantidad (14 × 12)
  "..............",
  "......k.......",
  "......kww.....",
  "......kwwww...",
...
const PESCADOR = [  // jefe de Chorrillos: el pescador que reparte por tramos (20 × 16)
  "......kkkkkkkk......",
  ".....kkkkkkkkkk.....",
  "....kkkkkkkkkkkk....",
  "......cccccccc......",
...
const CARRETILLA = [   // carretilla del parque industrial: carga todo junto sin ordenar (14 × 12)
  "..............",
  "..........mm..",
  ".........mm...",
  "..rrrrrrrrm...",
...
const LADRILLO = [   // ladrillos apilados: se salta los tramos y arma una sola pared (12 × 12)
  "............",
  "............",
  ".rrrrrrrrrr.",
  ".rrrr.rrrrr.",
...
const CASCO = [   // casco de obra: se olvida de comprobar en que tramo cayo (13 × 12)
  ".............",
  ".............",
  ".....www.....",
  "....ywwwy....",
...
const CAPATAZ = [  // jefe de Villa El Salvador: el capataz que reparte el trabajo mal (20 × 16)
  "......yyyyyy........",
  ".....yyyyyyyy.......",
  "....yyyyyyyyyy......",
  "......cccccc........",
